...
docker run --rm --name nitro-dev -p 8547:8547 -v /home/polar/git/stylus-sandbox:/app -w /app offchainlabs/nitro-node:v3.2.1-d81324d --dev --http.addr 0.0.0.0 --http.api=net,web3,eth,debug &
